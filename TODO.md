...
- [ ] Estendere la stessa passata `apple-design` alla **sidebar sinistra** e alla **top toolbar**: oggi usano ancora `tracking-widest` uniforme e transizioni ad-hoc, quindi la colonna destra è più curata del resto
